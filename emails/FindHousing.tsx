...
>>>>>>> 763137ed94b371187ad09a15a708b554330948de
...
=======
              <div style={{ width: "250px", height: "68px", gap: "8px", bottom: 20, right: 0, position: "absolute" }}>
                <div style={{ width: "250px", height: "26px", transform: "rotate(0deg)", fontFamily: "Roboto, sans-serif", fontWeight: 800, fontSize: "16 px", lineHeight: "26px", color: "#515558" }}>Move-in/Out Support</div>
>>>>>>> 763137ed94b371187ad09a15a708b554330948de
...
>>>>>>> 763137ed94b371187ad09a15a708b554330948de
                ...
                <div style={{ width: "468px", height: "52px", bottom: 0, position: "absolute" }}>
                  <div style={{ width: "468px", height: "52px", fontFamily: "YourFontFamily, sans-serif", fontWeight: "regular", fontSize: "16px", lineHeight: "26px", letterSpacing: "0.17px", textAlign: "center", color: "#94A3B8" }}>A great platform to find and lease your envisioned property without any agent and commisions</div>
                </div>
                <div style={{}}></div>
              </div>
            </div>
